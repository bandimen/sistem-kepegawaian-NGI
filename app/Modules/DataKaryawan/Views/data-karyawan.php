                                    ...
                                    <?php foreach ($karyawans as $index => $karyawan) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-warning btn-sm details-karyawan" data-id-karyawan="1" data-bs-toggle="modal" data-bs-target="#karyawanModal"
                                                    data-nama="<?= esc($karyawan['nama']) ?>">
